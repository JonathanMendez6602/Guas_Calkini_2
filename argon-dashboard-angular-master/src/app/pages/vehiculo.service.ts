...
export class VehiculoService {
  ...
  private apiURL = "http://127.0.0.1:8000/api/vehiculo";
  private corralon = "http://127.0.0.1:8000/api/corralon";
 ...
 getAll2(): Observable<Vehiculo[]> {
  return this.httpClient.get<Vehiculo[]>(this.corralon)
  .pipe(
    catchError(this.errorHandler)
  )
}
